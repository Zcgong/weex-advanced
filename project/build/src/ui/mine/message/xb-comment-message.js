...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/d9b67abb7a94adb6dc9926fbbed3acc0", [], function(__weex_require__, exports, __weex_module__){
	  ...
	  "children": [
	    {
	      "type": "xb-title-bar",
	      "attr": {
	        "leftItemSrc": function () {return this.vm.data.icBackUrl},
	        "title": "留言通知",
	        "rightItemTitle": "清空",
	    ...
	    },
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "repeat": function () {return this.vm.data.commentMessages},
	          "children": [
	            {
	              "type": "xb-comment-message-cell",
	              "attr": {
	                "messageId": function () {return this.id},
	                "iconUrl": function () {return this.iconUrl},
	                "nickName": function () {return this.nickName},
	                "messageContent": function () {return this.messageContent},
	...
	;__weex_bootstrap__("@weex-component/d9b67abb7a94adb6dc9926fbbed3acc0", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/xb-comment-message-cell", [], function(__weex_require__, exports, __weex_module__){
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.replyClick(this.messageId,$event)}
	          },
	          "children": [
	            {
	              "type": "text",
	    ...
	    },
	    {
	      ...
	      "attr": {
	        "value": function () {return this.messageContent}
	      }
	    }
	  ]
	})
